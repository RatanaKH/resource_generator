...
def test_make_repository(setup_data):
    result = runner.invoke(app, ["make-repository", "name", "Users"])
...
def test_make_repository_and_already_exist(setup_data):
    runner.invoke(app, ["make-repository", "name", "Users"])
    result = runner.invoke(app, ["make-repository", "name", "Users"])
