...
def test_make_controller(setup_data):
    result = runner.invoke(app, ["make-controller", "name", "Users"])
    print(result.stdout)
...
def test_make_controller_and_already_exist(setup_data):
    runner.invoke(app, ["make-controller", "name", "Users"])
    result = runner.invoke(app, ["make-controller", "name", "Users"])
